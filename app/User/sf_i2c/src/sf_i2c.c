...
#define I2C_PIN_SDA_LOW(p_dev) p_dev->port.sda_pin_out_low()

// SDA pin output high level
#define I2C_PIN_SDA_HIGH(p_dev) p_dev->port.sda_pin_out_high()

// SCL pin output low level
#define I2C_PIN_SCL_LOW(p_dev) p_dev->port.scl_pin_out_low()

// SCL pin output high level
#define I2C_PIN_SCL_HIGH(p_dev) p_dev->port.scl_pin_out_high()

// Read SDA pin level
#define I2C_PIN_SDA_READ(p_dev) p_dev->port.sda_pin_read_level()

// SDA pin input direction
#define I2C_PIN_SDA_DIR_INPUT(p_dev) p_dev->port.sda_pin_dir_input()

// SDA pin output direction
#define I2C_PIN_SDA_DIR_OUTPUT(p_dev) p_dev->port.sda_pin_dir_output();

//-----------------------------------------------------------------------------
// linked list function
//-----------------------------------------------------------------------------
// Insert node into linked list
#define INSERT_INTO(node)     \
  do {                        \
